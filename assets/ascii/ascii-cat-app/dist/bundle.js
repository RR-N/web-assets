...
}`,Hf=class{constructor(e,{fontSize:t=12,fontFamily:i="'Courier New', monospace",invert:r=!0,charset:s}={}){this.renderer=e,this.canvas=document.createElement("canvas"),this.ctx=this.canvas.getContext("2d"),this.pre=document.createElement("pre"),this.dom=document.createElement("div"),Object.assign(this.dom.style,{position:"absolute",inset:0}),this.dom.append(this.pre,this.canvas),this.fontSize=t,this.fontFamily=i,this.charset=s??" .'`^\",:;Il!i~+_-?][}{1)(|/tfjrxnuvczXYUJCLQ0OZmwqpdbkhao*#MW&8%B@$",this.invert=r}setSize(e,t){this.canvas.width=Math.floor(e/(this.fontSize*.6)),this.canvas.height=Math.floor(t/this.fontSize),this.ctx.font=`${this.fontSize}px ${this.fontFamily}`,Object.assign(this.pre.style,{margin:0,padding:0,lineHeight:"1em",mixBlendMode:"normal",color:"#000",fontFamily:this.fontFamily,fontSize:`${this.fontSize}px`,position:"absolute",left:"50%",top:"50%",transform:"translate(-50%,-50%)"})}render(e,t){this.renderer.render(e,t);let i=this.renderer.domElement,r=this.canvas.width,s=this.canvas.height,o=i.clientWidth||i.width,a=i.clientHeight||i.height;if(!r||!s||!o||!a)return;try{this.ctx.drawImage(i,0,0,r,s)}catch{return}let l;try{l=this.ctx.getImageData(0,0,r,s).data}catch{return}let c="";for(let u=0,f=l.length;u<f;u+=4){let m=u/4%r,x=(.3*l[u]+.6*l[u+1]+.1*l[u+2])/255,d=Math.floor((this.invert?x:1-x)*(this.charset.length-1));c+=this.charset[d],m===r-1&&(c+=`
